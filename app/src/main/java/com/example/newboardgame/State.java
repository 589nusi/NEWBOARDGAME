...
public abstract class State {
    ...
    public abstract State getState(byte[][] board, byte player) ;
    ...
    public  void setBoard(int m,int n,byte p){
        this.board[m][n]=p;

    }
    public abstract boolean oneMove(byte[][] b, int r, int c, byte aPlayer) ;
